...
This *Quick Tutorial for Traversal* is based on:
...
``quick_traversal``. The following diagram shows how this is structured
...
.. code-block:: bash
    ...
    c:\> mkdir projects
    c:\> cd projects
    c:\> mkdir quick_traversal
    c:\> cd quick_traversal
...
``quick_traversal``. A workspace is a common term used by integrated
...
.. code-block:: bash
    ...
    # Mac and Linux
    $ export VENV=~/projects/quick_traversal/env33/

    # Windows
    # TODO: This command does not work
    c:\> set VENV=c:\projects\quick_traversal\env33
...
.. code-block:: bash
    ...
    # ...into c:\projects\quick_traversal\ez_setup.py
